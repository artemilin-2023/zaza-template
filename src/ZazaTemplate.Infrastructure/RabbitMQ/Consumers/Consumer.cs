using ZazaTemplate.Infrastructure.RabbitMQ.Abstractions;
using ZazaTemplate.Infrastructure.RabbitMQ.Consumers.Abstractions;
using Microsoft.Extensions.Logging;
using RabbitMQ.Client;
using RabbitMQ.Client.Events;
using ResultSharp.Core;
using ResultSharp.Errors;
using ZazaTemplate.Application.Abstractions.RabbitMQ;

namespace ZazaTemplate.Infrastructure.RabbitMQ.Consumers
{
